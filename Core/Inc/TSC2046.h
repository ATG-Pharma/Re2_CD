...
//Calibration parameters used by Set_Cal_Vals. Run TSC2046_Calibrate and Print_Cal_Vals to determine values
#define SCALE_X_VALUE 0.150919
#define SCALE_Y_VALUE 0.195480
#define BIAS_X_VALUE -335.603668
#define BIAS_Y_VALUE -36.133171
//Typedefs
//1. Touch coordinates
typedef struct
{
...
//Print calibration values to screen
void Print_Cal_Vals(void);
//Set calibration parameters to values stored in macros at top of file
